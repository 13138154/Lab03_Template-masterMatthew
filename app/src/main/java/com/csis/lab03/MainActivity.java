...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try { // try the code below, catch errors if things go wrong
            ...
            loadPDPatch("homework.pd"); // This is the name of the patch in the zip
        } catch (IOException e) {
        ...
        slider3.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress,
                                                  boolean fromUser) {
                        slide3Value = progress;
                        sendFloatPD("slider3", slide3Value/100);
                    }
    ...
    private void loadPDPatch(String patchName) throws IOException
    {
        ...
        try {
            IoUtils.extractZipResource(getResources().openRawResource(R.raw.homework), dir, true); //extract the zip file in raw called homework
